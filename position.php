...
<head>
	...
	<meta property="og:url" content="http://www.blackfridaypromoweb.com/position.php"/>
        ...
        <div class="container my_container"> 
            <div class="cont_banner_presentation">
                <div class="banner_presentation_shadow">
                    <div class="row">  
                        <div class="col-md-12">
                            <p>User: <?php echo $usersList[0]['name']; ?></p>
							<p>BlackFridayPromoWeb identifier: <?php echo $usersList[0]['id']; ?></p>						
                            <p>You are in the position <?php echo $i; ?> out of a total of <?php echo $total; ?></p>
							<p>within the <?php echo $category; ?> category</p>
                            <p>And you already have ¡<?php echo $usersList[0]['points']; ?> points!</p>							
                        </div>     
                    </div>
                </div>            
            </div>                    
        ...
        <div class="container my_container"> 
            <div class="row">  
				...
				echo '
						<div class="box">
							<div class="box_title">
								<img src="img/bfpw.png" alt="position">
							</div>
							<div>
								<p>
									<center>
