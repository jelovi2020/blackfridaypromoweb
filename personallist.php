...
<head>
	...
	<meta property="og:url" content="http://www.blackfridaypromoweb.com/personallist.php"/>
            ...
            <div class="cont_banner_presentation">
                <div class="banner_presentation_shadow">
                    <div class="row">  
                        <div class="col-md-12">
							<h1>Personal</h1>						
                            <p>This category list will be displayed as follows</p>						                            
                        </div>     
                    </div>
                </div>            
            </div>
			<div class="lists-button">			
				<input type="button" value="Change to Companies list" onclick="$(location).attr('href','companieslist.php');" />
			</div>						
        </div>
    </section>
        ...
        <div class="container my_container"> 
            <div class="row">  
				...
				for ($i = 0; $i < 3; $i++) {
										...
										<span>
											<center>
												<img src="img/right_arrow.png" width="25" height="25">
													<strong><a href="' . $usersList[$i]['link'] . '" target="_blank"> Visit their website </a></strong>
					...
					echo '		
									<p> 
										<sub>Points: ' . $usersList[$i]['points'] . '</sub>
									</p>
								</div>
							</div>  
						</div>  
