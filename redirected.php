...
<head>
	...
	<meta property="og:url" content="http://www.blackfridaypromoweb.com/redirected.php"/>
        ...
        <div class="container my_container"> 
            <div class="cont_banner_presentation">
                <div class="banner_presentation_shadow">
                    <div class="row">  
                        <div class="col-md-12">
                            <h1>Hello <?php echo $_POST['formGroupNameInput']; ?> </h1>
                            <p>This is your BlackFridayPromoWeb identifier <img src="img/right_arrow.png" width="25" height="25"> <?php echo $id; ?> <img src="img/left_arrow.png" width="25" height="25"><strong> Please, do not forget to write down this identifier</strong></p>
							<p>And you have paid: <?php echo $_POST['amountInput']; ?> Euros</p>
                            <hr />
                        </div>     
                    </div>
                </div>            
