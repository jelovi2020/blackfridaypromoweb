...
<head>
	...
	<meta property="og:url" content="http://www.blackfridaypromoweb.com/es/position.php"/>
        ...
        <div class="container my_container"> 
            <div class="cont_banner_presentation">
                <div class="banner_presentation_shadow">
                    <div class="row">  
                        <div class="col-md-12">
                            <p>Usuario: <?php echo $usersList[0]['name']; ?></p>
							<p>Identificador BlackFridayPromoWeb: <?php echo $usersList[0]['id']; ?></p>						
                            <p>Estás en la posición <?php echo $i; ?> de <?php echo $total; ?></p>
							<p>dentro de la categoría <?php echo $category; ?></p>
                            <p>Y ya tienes ¡<?php echo $usersList[0]['points']; ?> puntos!</p>							
                        </div>     
                    </div>
                </div>            
            </div>                    
