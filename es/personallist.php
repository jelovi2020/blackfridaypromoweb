...
<head>
	...
	<meta property="og:url" content="http://www.blackfridaypromoweb.com/es/personallist.php"/>
    ...
    <section>
        <div class="container my_container"> 
			...
			<div class="lists-button">			
				<input type="button" value="Cambiar al listado de Empresas" onclick="$(location).attr('href','companieslist.php');" />
			</div>						
        </div>
    </section>
					...
					if (!is_null($usersList[$i]['image']) && !empty($usersList[$i]['image']) && !is_null($usersList[$i]['link']) && !empty($usersList[$i]['link'])) {
						echo '
									...
									<p> 
										<a href="' . $usersList[$i]['link'] . '" target="_blank">
											<center>
												<img src="' . $usersList[$i]['image'] . '" alt="Image" width="80" height="80" style="border:0px solid black">
											</center>
										</a>
									</p>						
						', PHP_EOL;
